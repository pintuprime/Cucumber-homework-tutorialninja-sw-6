...
public class LaptopAndNotebookPageSteps {
    ...
    public void iFilledAllMandatoryFieldOfCheckoutPage() {
        new CheckoutPage().enterFirstName("Tom");
        new CheckoutPage().enterLastName("Patel");
        new CheckoutPage().enterEmailId("mnb");
        new CheckoutPage().enterTelephone("01122334455");
        new CheckoutPage().enterAddressLine1("10 downing road");
        new CheckoutPage().enterCity("London");
        new CheckoutPage().enterPostCode("ec1 2rx");
